...
Also if you are not familiar with MoTion, using it for the first time, no worries; here are some pages with examples: https://github.com/alesshosry/MoTionPatternsBook. You can check them OR provide the files to AI agents so they can create the patterns for you ;) 
